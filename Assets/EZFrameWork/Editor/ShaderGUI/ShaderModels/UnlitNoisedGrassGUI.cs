...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    public static class UnlitNoisedGrassGUI
    {
        ...
        public struct NoisedGrassProperties
        {
            // Surface Input Props
            public MaterialProperty noiseMapProp { get; set; }
            //protected MaterialProperty noiseColorProp { get; set; }

            public NoisedGrassProperties(MaterialProperty[] properties)
            {
                // Surface Input Props
                noiseMapProp = BaseShaderGUI.FindProperty("_NoiseMap", properties);
                //noiseColorProp = BaseShaderGUI.FindProperty("_NoiseMap", properties, false);
            }
        }
